...
func TestBlockchainAllowanceGet(t *testing.T) {
...
func TestBlockchainAllowanceApprove(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Blockchain.Allowance.Approve(context.TODO(), morpheusmarketplace.BlockchainAllowanceApproveParams{
